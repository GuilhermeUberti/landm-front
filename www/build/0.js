...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__meus_pedidos__ = __webpack_require__(322);
...
var MeusPedidosPageModule = /** @class */ (function () {
    ...
    MeusPedidosPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_4__meus_pedidos__["a" /* MeusPedidosPage */],
            ],
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["h" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_4__meus_pedidos__["a" /* MeusPedidosPage */]),
            ],
        })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__app_models_usuarioModel__ = __webpack_require__(312);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_carrinho_carrinho__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ionic_angular__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__app_models_carrinhoModel__ = __webpack_require__(211);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MeusPedidosPage = /** @class */ (function () {
    function MeusPedidosPage(navCtrl, navParams, carrinhoSrv, usuarioSrv) {
        this.navCtrl = navCtrl;
        ...
        this.page = 0;
        this.usuarioLogado = new __WEBPACK_IMPORTED_MODULE_1__app_models_usuarioModel__["a" /* UsuarioModel */]();
        this.carrinho = new __WEBPACK_IMPORTED_MODULE_7__app_models_carrinhoModel__["a" /* CarrinhoModel */]();
    }
    ...
    MeusPedidosPage.prototype.LoadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        user = JSON.parse(localStorage.getItem(__WEBPACK_IMPORTED_MODULE_0__app_helpers_configHelper__["a" /* ConfigHelper */].storageKeys.user));
    ...
    MeusPedidosPage.prototype.doInfinite = function (infiniteScroll) {
        setTimeout(function () {
    ...
    MeusPedidosPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["m" /* Component */])({
            selector: 'page-meus-pedidos',template:/*ion-inline-start:"D:\NoFood\NoFood.Ionic\src\pages\meus-pedidos\meus-pedidos.html"*/'<ion-header>\n  <ion-navbar color="dark">\n    <ion-title>Meus Pedidos</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content no-padding>\n  <div (click)="visualizarPedido()" tappable>\n    <ion-card *ngFor="let item of lista">\n      <ion-card-header icon-left>\n        <ion-icon name="cart"></ion-icon>      \n        Pedido realizado em {{ item.dataPedido | date:\'dd/MM/yyyy\' }}\n      </ion-card-header>\n      <ion-card-content>\n        <p>Você comprou {{ contaItem(item) }} produtos neste dia.</p>\n        <p>Valor total da compra: <strong>{{ item.valorTotal | real }}</strong></p>\n        <p>Nome Cliente: <strong>{{usuarioLogado.nome}}</strong></p>\n        <p>Endereço Cliente: {{usuarioLogado.enderecoCompleto}}</p>\n      </ion-card-content>\n    </ion-card>\n  </div>\n  \n\n  <ion-infinite-scroll (ionInfinite)=\'doInfinite($event)\'>\n    <ion-infinite-scroll-content></ion-infinite-scroll-content>\n  </ion-infinite-scroll>\n</ion-content>\n<tab [pagina]="\'MeusPedidos\'"></tab>'/*ion-inline-end:"D:\NoFood\NoFood.Ionic\src\pages\meus-pedidos\meus-pedidos.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6_ionic_angular__["k" /* NavController */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__providers_carrinho_carrinho__["a" /* CarrinhoProvider */],
